...
export var VirtualizedMUIGrid = forwardRef(function (_a, ref) {
    ...
    } : _d, _e = _a.containerHeight, containerHeight = _e === void 0 ? 300 : _e, data = _a.data, listItemProps = _a.listItemProps, _f = _a.preRenderRowCount, preRenderRowCount = _f === void 0 ? 3 : _f, renderItem = _a.renderItem, renderItemKey = _a.renderItemKey, _g = _a.rowHeight, rowHeight = _g === void 0 ? 300 : _g, _h = _a.spacing, spacing = _h === void 0 ? 0 : _h, _j = _a.variant, variant = _j === void 0 ? 'Grid' : _j;
    ...
    var renderItemsForRow = function (rowData, i) {
        return variant === 'List' ? (renderItem(rowData, i)) : (React.createElement(Grid, { item: true, key: rowData[renderItemKey], style: {
                height: rowHeight,
    ...
    var renderRow = function (row) {
        ...
        return (React.createElement(VirtualItem, { height: rowHeight, key: row, listItemProps: listItemProps, offset: (((_a = containerRef === null || containerRef === void 0 ? void 0 : containerRef.current) === null || _a === void 0 ? void 0 : _a.clientHeight) || 0) + rowHeight * preRenderRowCount, spacing: spacing, target: containerRef === null || containerRef === void 0 ? void 0 : containerRef.current, top: row * rowHeight, variant: variant }, filterRowData.map(renderItemsForRow)));
    };
    return (React.createElement(Grid, { className: classes.root, container: true, "data-testid": "virtualized-grid-component", ref: containerRef, spacing: spacing, style: {
        ...
        } }, (data === null || data === void 0 ? void 0 : data.length) ? (variant === 'List' ? (React.createElement(List, { className: classes.scrollableListContainerStyle, "data-testid": "virtualized-list-component" }, rows === null || rows === void 0 ? void 0 : rows.map(renderRow))) : (React.createElement(Grid, { container: true, className: classes.scrollableContainerStyle, item: true }, rows === null || rows === void 0 ? void 0 : rows.map(renderRow)))) : (React.createElement(Grid, { container: true, justify: "center" },
